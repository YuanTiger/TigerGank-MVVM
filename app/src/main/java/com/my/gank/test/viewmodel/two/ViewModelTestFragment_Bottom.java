 ...
 * -----------
 */
public class ViewModelTestFragment_Bottom extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_view_model_bottom, container, false);
        seekBar = rootView.findViewById(R.id.seek_bar_bottom);
